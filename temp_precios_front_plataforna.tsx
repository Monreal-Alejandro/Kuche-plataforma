...
const catalogoInicial = [
  ...
  },
  {
    category: "HERRAJES",
    items: [
      { id: "herr_cajon_sen", label: "Caj├│n sencillo", unitPrice: 120, unit: "pz" },
      { id: "herr_cajon_len", label: "Caj├│n Cierre lento", unitPrice: 450, unit: "pz" },
      { id: "herr_cajon_blum", label: "Caj├│n BLUM tandem", unitPrice: 700, unit: "pz" },
      ...
      { id: "herr_piston_sen", label: "Pist├│n sencillo", unitPrice: 40, unit: "pz" },
      { id: "herr_piston_blum", label: "Pist├│n blum", unitPrice: 350, unit: "pz" },
  ...
  {
    category: "EXTRA├ìBLES Y ELECTRODOM├ëSTICOS",
    items: [
...
export default function PreciosPage() {
  ...
  const handleAddMaterial = () => {
    ...
    if (!trimmedId || !trimmedLabel || !trimmedUnit || Number.isNaN(parsedPrice)) {
      setAddError("Completa todos los campos y agrega un precio v├ílido.");
      return;
    }
    const idExists = items.some((item) => item.id.toLowerCase() === trimmedId.toLowerCase());
    if (idExists) {
      setAddError("El ID ya existe. Usa un ID ├║nico.");
      return;
    }
    setItems((prev) => [
      ...prev,
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Cat├ílogo y Precios</h1>
          <p className="mt-2 text-sm text-gray-500">
            Actualiza los costos base. Los cambios afectar├ín las nuevas cotizaciones.
          </p>
        </div>
